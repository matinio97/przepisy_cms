...
const UserRecipeCart = ({ recipe }) => {
	...
	const tooltipStatusText =
		recipeStatus === "accepted"
			? "Przepis został zaakceptowany. Jest widoczny dla wszystkich użytkowników."
			: recipeStatus === "rejected"
			? "Administratorowi nie spodobał się przepis lub zostały w nim zawarte wulgaryzmy, itp. Dokonaj zmian."
			: "Przepis jest w trakcie weryfikacji przez administratora.";
	...
	return (
		<Table.Row>
			...
			<Modal>
				...
				<Modal.Window name="edit" outsideClickClose={false}>
					<AddRecipeForm recipeToEdit={recipe} id={id} />
				</Modal.Window>
